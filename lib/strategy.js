 ...
 *         callbackURL: 'https://www.example.net/auth/Graph/callback'
 *       },
...
function MicrosoftGraphStrategy(options, verify) {
    options = options || {}
...
util.inherits(MicrosoftGraphStrategy, OAuth2Strategy)
...
MicrosoftGraphStrategy.prototype.userProfile = function (accessToken, done) {
...
module.exports = MicrosoftGraphStrategy
