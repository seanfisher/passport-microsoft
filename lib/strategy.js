...
function MicrosoftStrategy(options, verify) {
  ...
  options.apiEntryPoint =
    options.apiEntryPoint || "https://graph.microsoft.com/";
  ...
  this._addUPNAsEmail =
    "addUPNAsEmail" in options ? options.addUPNAsEmail : false;
}
  ...
  strategy._oauth2.get(
    ...
    function (err, body, res) {
      ...
      try {
        ...
        profile.emails = [];
        var isNotEmpty = (str) =>
          str && typeof str === "string" && str.trim().length;
